...
- [Endaoments](concepts/endaoments.md)
- [FAQs](concepts/faqs.md)

## Use Cases

- [Open Source Projects](use-cases/open-source-projects.md)
- [Content creators / Influencers](use-cases/content-creators-influencers.md)
...
- [Roadmap](https://roadmap.endao.finance/roadmap)
